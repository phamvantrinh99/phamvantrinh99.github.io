using TraditionalMedicalClinic.Controllers;
using TraditionalMedicalClinic.Models.Blocks;
using TraditionalMedicalClinic.Models.Pages;
using EPiServer.ServiceLocation;
using EPiServer.Web;
using EPiServer.Web.Mvc;

namespace TraditionalMedicalClinic.Business.Rendering;
...
public class TemplateCoordinator : IViewTemplateModelRegistrator
{
    ...
    public const string TMCPageFolder = "~/Views/TMC/Pages/";
    public const string TMCBlockFolder = "~/Views/TMC/Blocks/";
